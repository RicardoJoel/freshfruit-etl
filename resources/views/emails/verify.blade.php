<table style="border-top:3px solid #5AB248;border-bottom:3px solid #5AB248;" width="600" align="center">
    <tbody>
                ...
                <table width="100%" cellspacing="0" cellpadding="0">
                    <tbody><tr>
                        <td>
                            ...
                            <p style="color:#808080;margin: 0;font-size: 16px;">Te ha llegado este correo porque te hemos creado una cuenta en el sistema <span style="color:#5AB248"><b>{{ config('app.name', 'Laravel') }}</b></span>.</p>
                        </td>
                        <td>
        ...
        <tr>
            <td style="padding-right: 20px;padding-left: 20px;padding-top: 10px;">
                <p style="margin: 0;padding-bottom: 15px;font-size: 16px;color: #808080;">Si estás teniendo problemas con el enlace, copia y pega la siguiente dirección en tu buscador web: <a href="{{url('/activate/'.$code)}}" style="color: #5AB248;">{{url('/activate/'.$code)}}</a></p>
            </td>
        </tr>
    </tbody>
</table>