    ...
    <tbody>
                ...
                <table width="100%" cellspacing="0" cellpadding="0">
                    <tbody><tr>
                        <td>
                            ...
                            <p style="color:#808080;margin: 0;font-size: 16px;">Te ha llegado este correo porque hemos recibido una solicitud de restablecimiento de contraseña para tu cuenta en <span style="color:#5AB248"><b>{{ config('app.name', 'Laravel') }}</b></span>.</p>
                        </td>
                        <td>
        ...
        <tr>
            <td style="padding-right: 20px;padding-left: 20px;padding-top: 10px;">
                <p style="margin: 0;padding-bottom: 15px;font-size: 16px;color: #808080;">De no haberlo solicitado, omite el mensaje. De lo contrario, ingresa <a href="{{url('/password/reset/'.$code)}}" style="color: #5AB248;">aquí</a>.</p>
        ...
        <tr>
            <td style="padding-right: 20px;padding-left: 20px;padding-top: 10px;">
                <p style="margin: 0;padding-bottom: 15px;font-size: 16px;color: #808080;">Si estás teniendo problemas con el enlace, copia y pega la siguiente dirección en tu buscador web: <a href="{{url('/password/reset/'.$code)}}" style="color: #5AB248;">{{url('/password/reset/'.$code)}}</a></p>
            </td>
        </tr>
    </tbody>
</table>