...
<div id="subtitle" class="fila">
	<div class="columna columna-1">
		<div class="span-fail" id="fail_div" style="margin-bottom:20px"><span id="fail_msg"></span></div>
	</div>
</div>
<div class="fila">
	<div class="columna columna-1">
	...
	<div id="div-gen">
		...
		<div class="fila">
			...
			<div class="columna columna-5d">
				<input type="text" name="customer_name" id="customer_name" value="{{ old('customer_name') }}" placeholder=" -- No hay información para mostrar -- " disabled required>
			</div>
			<div class="columna columna-5">
		...
		<div class="fila">
			...
			<div class="columna columna-5d">
				<input type="text" name="user_wholename" id="user_wholename" value="{{ old('user_wholename') }}" placeholder=" -- No hay información para mostrar -- " disabled required>
			</div>
			<div class="columna columna-5">
...
<div class="fila">
	...
	<div class="columna columna-1">
		<center>
		<button type="submit" class="btn-effie" id="btn-submit"><i class="fa fa-save"></i>&nbsp;{{ __('Registrar') }}</button>
...
<div class="fila">
	<div class="space"></div>
	<div class="columna columna-1">
		<p><i class="fa fa-info-circle fa-icon"></i>&nbsp;<b>Importante</b><ul>
...
$(function() {
	$('#btn-submit').click(function() {
		...
		.fail(function(msg) {
			...
			$('#fail_msg').html(alert(JSON.stringify(msg)));
