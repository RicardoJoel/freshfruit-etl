...
class MaritimoController extends Controller
{
    ...
    protected const MSG_FND_RNGMNF = 'Hemos encontrado manifiestos ya registrados entre las fechas ingresadas.';
    ...
    public function loadData(Request $request)
    {
        self::validate($request, [
            'mar_fecIni' => 'required|date_format:Y-m-d',
            'mar_fecFin' => 'required|date_format:Y-m-d|after_or_equal:mar_fecIni',
        ...
        $manifests = [];
        for ($i=0; $i<$cont; $i++) {
            $urls="http://www.aduanet.gob.pe/cl-ad-itconsmanifiesto/manifiestoITS01Alias?accion=consultarManifiesto&fech_llega_ini=$fecIni&fech_llega_fin=$fecFin&matr_nave=$nave&ConsultaManifExpMarFecha.jsp?accion=/cl-ad-itconsmanifiesto/ConsultaManifExpMarFecha.jsp&tamanioPagina=".self::NUM_MNF_PAGINA."&pagina=0";
            ...
            //dd($sitios);
            $manifests = array_merge($manifests, $sitio->filter('table.beta  tr.bg a')->each(function ($node) {
                return [
    ...
    public static function validationErrorMessages()
    {
        return [
            ...
            'mar_fecFin.after_or_equal' => 'La fecha de término no puede ser anterior a la fecha de inicio.',
