...
class UserController extends Controller
{
    ...
    protected const MSG_NOT_FOUNDX = 'El colaborador solicitado no ha sido encontrado.';
    protected const MSG_SCS_UPDUSR = 'El colaborador con código value fue actualizado de manera exitosa.';
    protected const MSG_ERR_UPDUSR = 'Lo sentimos, ocurrió un problema mientras se intentaba actualizar el colaborador.';
    protected const MSG_SCS_DLTUSR = 'El colaborador con código value fue eliminado de manera exitosa.';
    protected const MSG_ERR_DLTUSR = 'Lo sentimos, ocurrió un problema mientras se intentaba eliminar el colaborador.';
    ...
    {
        $users = User::where('id','!=',1)->orderByRaw('lastname','name')->paginate(1000000);
    ...
    public function update(Request $request, $id)
    {
        ...
        $this->validate($request, [
            ...
            'district_id' => 'required|int|min:1',
            ...
            'contact_district_id' => 'nullable|int|min:1',
    ...
    public function getByDocument($doc) {
        $users = User::where('document',$doc)->get(['id','code','document',DB::raw('concat(users.name," ",users.lastname) as name')]);
    ...
    public static function validationErrorMessages()
    {
        ...
        return [
            ...
            'gender_id.required' => 'Debes seleccionar obligatoriamente un género.',
            'gender_id.int' => 'El ID del género seleccionado no tiene un formato válido.',
            'gender_id.min' => 'El ID del género seleccionado es inválido.',
            ...
            'district_id.required' => 'Debes seleccionar obligatoriamente un distrito de domicilio.',
            'district_id.int' => 'El ID del distrito de domicilio seleccionado no tiene un formato válido.',
            'district_id.min' => 'El ID del distrito de domicilio seleccionado es inválido.',
            ...
            'relationship_id.required' => 'Debes seleccionar obligatoriamente un vínvulo laboral.',
            'relationship_id.int' => 'El ID del vínvulo laboral seleccionado no tiene un formato válido.',
            'relationship_id.min' => 'El ID del vínvulo laboral seleccionado es inválido.',

            'department_id.required' => 'Debes seleccionar obligatoriamente un área funcional.',
            'department_id.int' => 'El ID del área funcional seleccionada no tiene un formato válido.',
            'department_id.min' => 'El ID del área funcional seleccionada es inválido.',

            'profile_id.required' => 'Debes seleccionar obligatoriamente un cargo.',
            'profile_id.int' => 'El ID del cargo seleccionado no tiene un formato válido.',
            'profile_id.min' => 'El ID del cargo seleccionado es inválido.',
            ...
            'frequency_id.required' => 'Debes seleccionar obligatoriamente una frecuencia de variación salarial.',
            'frequency_id.int' => 'El ID de la frecuencia de variación salarial no tiene un formato válido.',
            'frequency_id.min' => 'El ID de la frecuencia de variación salarial seleccionada es inválido.',
            ...
            'bank_id.required' => 'Debes seleccionar obligatoriamente una entidad bancaria Sueldo.',
            'bank_id.int' => 'El ID de la entidad bancaria Sueldo no tiene un formato válido.',
            'bank_id.min' => 'El ID de la entidad bancaria Sueldo seleccionada es inválido.',
            ...
            'afp_id.required' => 'Debes seleccionar obligatoriamente una Adm. Fondo de pensiones.',
            'afp_id.int' => 'El ID de la Adm. Fondo de pensiones no tiene un formato válido.',
            'afp_id.min' => 'El ID de la Adm. Fondo de pensiones seleccionada es inválido.',

            'commission_id.required' => 'Debes seleccionar obligatoriamente un tipo de comisión.',
            'commission_id.int' => 'El ID del tipo de comisión no tiene un formato válido.',
            'commission_id.min' => 'El ID del tipo de comisión seleccionada es inválido.',
            ...
            'cts_id.required' => 'Debes seleccionar obligatoriamente una entidad bancaria CTS.',
            'cts_id.int' => 'El ID de la entidad bancaria CTS no tiene un formato válido.',
            'cts_id.min' => 'El ID de la entidad bancaria CTS seleccionada es inválido.',
            ...
            'eps_id.min' => 'El ID del plan EPS seleccionado es inválido.',
            ...
            'contact_district_id.int' => 'El ID del distrito del contacto en caso de emergencia seleccionado no tiene un formato válido.',
            'contact_district_id.min' => 'El ID del distrito del contacto en caso de emergencia seleccionado es inválido.',

            'contact_country_id.int' => 'El ID del código país del contacto en caso de emergencia seleccionado no tiene un formato válido.',
            'contact_country_id.min' => 'El ID del código país del contacto en caso de emergencia seleccionado es inválido.',
