...
class User extends Authenticatable implements MustVerifyEmail
{
    ...
    protected $fillable = [
        ...
        'address', 'district_id', 'country_id', 'mobile', 'phone', 'annex', 'alt_email',
        ...
        'contact_fullname', 'contact_relationship', 'contact_address', 'contact_district_id', 'contact_country_id', 
